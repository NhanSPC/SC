...
Namespace SC
    ...
    <Serializable()> _
    Public Class WOEs
        Inherits Csla.BusinessListBase(Of WOEs, WOE)
...
#Region " Business Methods"
        ...
        Protected Overrides Function AddNewCore() As Object
            If _parent IsNot Nothing Then
                Dim theNewLine = WOE.NewWOE(_parent.WoId)
        ...
        Friend Sub AddNewLine(ByVal pLine As WOE)
...
#Region " Factory Methods "
        ...
        Friend Shared Function NewWOEs(ByVal pParent As WO) As WOEs
            Return New WOEs(pParent)
        End Function

        Friend Shared Function GetWOEs(ByVal dr As SafeDataReader, ByVal parent As WO) As WOEs
            Dim ret = New WOEs(dr, parent)
            ret.MarkAsChild()
            Return ret
        End Function
...
#Region " Data Access "
        ...
        Friend Sub Update(ByVal cn As SqlConnection, ByVal parent As WO)
            ...
            For Each deletedChild As WOE In DeletedList
